...
# ============================================================
# PROJECT ROOT
# SAFE/streamlit/pages/car/return_2025.py
# ============================================================
...
with st.container(
    ...
    with head_left:
        ...
        st.html(
            ...
            <div class="page-sub">
                2025년 지역별·연령별 운전면허 자진반납 현황을 분석하여
    ...
    if not filtered.empty:
        ...
        st.html(
            ...
            <div class="info-box">
                ...
                자진반납이 가장 많은 지역은
                <b>{top_region}</b>이며,
                총 <b>{top_region_count:,}건</b>입니다.
                <br>

                가장 많은 자진반납이 발생한 연령은
                <b>{top_age}</b>이며,
                총 <b>{top_age_count:,}건</b>입니다.
