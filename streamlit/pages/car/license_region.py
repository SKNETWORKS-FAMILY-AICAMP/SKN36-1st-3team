...
# ============================================================
# PROJECT ROOT
# SAFE/streamlit/pages/car/license_region.py
# ============================================================
...
with st.container(
    ...
    with head_left:
        ...
        st.html(
            ...
            <div class="page-sub">
                대한민국 시도별 운전면허 소지자 분포를 지도에서 확인하고,
                지역별 면허 보유 규모를 비교합니다.
            </div>
            """
        )
        ...
        with st.container(
            ...
            st.html(
                ...
                <div class="panel-title">
                    대한민국 시도별 운전면허 소지자 분포
                </div>

                <div class="panel-sub">
                    지도에서는 경기남부와 경기북부를 경기도로 합산합니다.
                    색상은 지역별 면허 소지자 규모의 상대적 수준을 나타냅니다.
                </div>
                """
            )
    ...
    if not ranking_df.empty:
        ...
        st.html(
            ...
            <div class="info-box">
                ...
                선택한 조건에서 전국 운전면허 소지자는
                <b>{total_count:,}명</b>입니다.<br>

                원본 데이터 기준 면허 소지자가 가장 많은 권역은
                <b>{top_region}</b>이며,
                면허 소지자는
                <b>{top_region_count:,}명</b>입니다.<br><br>

                대한민국 지도에서는 행정구역 표현을 위해
                <b>경기남부와 경기북부를 경기도로 합산</b>합니다.<br>

                지도 색상은 지역별 면허 소지자 수의
                <b>상대적 순위</b>를 기준으로 표현하여
                지역 간 차이를 더 명확하게 보여줍니다.
    ...
    if "show_license_region_detail" not in st.session_state:

        st.session_state[
            "show_license_region_detail"
        ] = False
    ...
    with st.container(
        ...
        detail_button_label = (
            "▲ 지역별 운전면허 소지자 데이터 닫기"
            if detail_open
            else "▼ 지역별 운전면허 소지자 데이터 상세 보기"
        )


        if st.button(
            detail_button_label,
            key="license_region_detail_button",
            use_container_width=True
        ):
    ...
    if st.session_state[
        ...
        with st.container(
            ...
            st.html(
                ...
                .license-region-dark-table-wrap {{
                ...
                .license-region-dark-table thead {{
                ...
                .license-region-dark-table tbody tr:nth-child(even) td {{

                    background: #1B243A;
                }}


                .license-region-dark-table tbody tr:hover td {{
                ...
                .license-region-dark-table tbody tr:last-child td {{
                ...
                <div class="license-region-dark-table-wrap">

                    <table class="license-region-dark-table">
