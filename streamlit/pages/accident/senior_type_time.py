...
.st-key-senior_type_detail_toggle button {
...
.st-key-senior_type_detail_toggle button:hover {
...
.st-key-senior_type_detail_panel {
...
with st.container(
    ...
    if "show_senior_type_detail" not in st.session_state:

        st.session_state[
            "show_senior_type_detail"
        ] = False
    ...
    with st.container(
        ...
        detail_button_label = (
            "▲ 고령운전자 사고유형·시간대 데이터 닫기"
            if detail_open
            else "▼ 고령운전자 사고유형·시간대 데이터 상세 보기"
        )


        if st.button(
            detail_button_label,
            key="senior_type_detail_button",
            use_container_width=True
        ):
    ...
    if st.session_state[
        ...
        with st.container(
            ...
            st.html(
                ...
                .senior-type-dark-table tbody tr:nth-child(even) td {{

                    background: #1B243A;
                }}


                .senior-type-dark-table tbody tr:hover td {{
                ...
                .senior-type-dark-table tbody tr:last-child td {{
                ...
                <div class="senior-type-dark-table-wrap">

                    <table class="senior-type-dark-table">
